    ...
    return Scaffold(
      ...
      body: PageView(
        ...
        children: [
          ...
          // Page 1: Categories (Embedded AddTransactionScreen)
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            ...
            right: 0,
            child: Container(
              color: Colors.white, // Opaque background hides scrolled list behind it
        ...
        children: [
          ...
          isHistoryActive
              ...
              : IconButton(
                  ...
                  icon: const Icon(Icons.receipt_long_rounded, color: Colors.grey, size: 22),
                ),
